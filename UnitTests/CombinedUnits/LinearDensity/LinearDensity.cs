...
{
    [TestClass]
    public class LinearDensityTest
    {
        ...
        public void LinearDensityAutoTest()
        {
            ...
            foreach (var EU in UnitEnumbase.ListOf<LinearDensityUnit>())
            {
                ...
                var UNList = UnitsNet.LinearDensity.Units.Where(x => x.ToString() == EU.QuantityName);
