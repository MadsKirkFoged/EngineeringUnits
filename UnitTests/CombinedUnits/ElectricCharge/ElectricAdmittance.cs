...
{
    [TestClass]
    public class ElectricChargeTest
    {
        ...
        public void ElectricChargeAutoTest()
        {
            ...
            foreach (var EU in UnitEnumbase.ListOf<ElectricChargeUnit>())
            {
                ...
                var UNList = UnitsNet.ElectricCharge.Units.Where(x => x.ToString() == EU.QuantityName);
