...
public class DensityTests
{
    ...
    public void Multiply()
    {
        ...
        var ResultU1 = UnitsNet.Density.FromKilogramsPerCubicMeter(massU.Kilograms / (lengthU.Meters * lengthU.Meters * lengthU.Meters));
        var ResultU2 = UnitsNet.Density.FromKilogramsPerCubicMeter(massU.Kilograms / (areaU.SquareMeters * lengthU.Meters));
        var ResultU3 = UnitsNet.Density.FromKilogramsPerCubicMeter(massU.Kilograms / volumeU.CubicMeters);
        var Result1 = UnitsNet.Density.FromKilogramsPerCubicMeter(ResultU1.KilogramsPerCubicMeter / ResultU2.KilogramsPerCubicMeter * ResultU3.KilogramsPerCubicMeter);
