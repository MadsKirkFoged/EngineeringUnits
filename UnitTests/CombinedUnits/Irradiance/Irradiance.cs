...
namespace UnitTests
{
    ...
    public class IrradianceTest
    {
        ...
        public void IrradianceAutoTest()
        {
            ...
            foreach (var EU in UnitTypebase.ListOf<IrradianceUnit>())
            {
                ...
                var UNList = UnitsNet.Irradiance.Units.Where(x => x.ToString() == EU.QuantityName);
                ...
                if (UNList.Count() == 1)
                {
                    ...
                    if (UN == UnitsNet.Units.IrradianceUnit.NanowattPerSquareMeter) Error = 0.0001220703125;
