...
namespace UnitTests
{
    ...
    public class IlluminanceTest
    {
        ...
        public void IlluminanceAutoTest()
        {
            ...
            var A2 = new EngineeringUnits.Illuminance(1, EngineeringUnits.IlluminanceUnit.Lux);
            ...
            foreach (var EU in Enumeration.ListOf<IlluminanceUnit>())
            {
                ...
                var UNList = UnitsNet.Illuminance.Units.Where(x => x.ToString() == EU.QuantityName);
