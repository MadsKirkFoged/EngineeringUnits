...
{
    [TestClass]
    public class MagnetizationTest
    {
        ...
        public void MagnetizationAutoTest()
        {
            ...
            foreach (var EU in UnitEnumbase.ListOf<MagnetizationUnit>())
            {
                ...
                var UNList = UnitsNet.Magnetization.Units.Where(x => x.ToString() == EU.QuantityName);
