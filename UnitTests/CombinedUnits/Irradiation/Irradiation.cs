...
namespace UnitTests
{
    ...
    public class IrradiationTest
    {
        ...
        public void IrradiationAutoTest()
        {
            ...
            var A2 = new EngineeringUnits.Irradiation(1, EngineeringUnits.IrradiationUnit.JoulePerSquareMeter);
            ...
            foreach (var EU in Enumeration.ListOf<IrradiationUnit>())
            {
                ...
                var UNList = UnitsNet.Irradiation.Units.Where(x => x.ToString() == EU.QuantityName);
