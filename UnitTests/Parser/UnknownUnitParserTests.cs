...
namespace UnitTests.ParserNew
{
    ...
    public class UnknownUnitParserTests
    {
        ...
        {
            var ok = QuantityParser.TryParse(input, out var u, CultureInfo.InvariantCulture);
        ...
        {
            QuantityParser.TryParse("1 N*m", out var a, CultureInfo.InvariantCulture);
            QuantityParser.TryParse("1 kg*m^2/s^2", out var b, CultureInfo.InvariantCulture);
