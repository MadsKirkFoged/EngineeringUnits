...
namespace EngineeringUnits
{
    public partial class SpecificEnergy
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CaloriesPerGram->CaloriePerGram")]
        public double CaloriesPerGram => As(SpecificEnergyUnit.CaloriePerGram);

        /// <summary>
        ///     Get SpecificEnergy in GigawattDaysPerKilogram.
        /// </summary>
        [Obsolete("Use without the 's' - GigawattDaysPerKilogram->GigawattDayPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - GigawattDaysPerShortTon->GigawattDayPerShortTon")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - GigawattDaysPerTonne->GigawattDayPerTonne")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - GigawattHoursPerKilogram->GigawattHourPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - JoulesPerKilogram->JoulePerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilocaloriesPerGram->KilocaloriePerGram")]
        public double KilocaloriesPerGram => As(SpecificEnergyUnit.KilocaloriePerGram);

        /// <summary>
        ///     Get SpecificEnergy in KilojoulesPerKilogram.
        /// </summary>
        [Obsolete("Use without the 's' - KilojoulesPerKilogram->KilojoulePerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilowattDaysPerKilogram->KilowattDayPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilowattDaysPerShortTon->KilowattDayPerShortTon")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilowattDaysPerTonne->KilowattDayPerTonne")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilowattHoursPerKilogram->KilowattHourPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegajoulesPerKilogram->MegajoulePerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegawattDaysPerKilogram->MegawattDayPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegawattDaysPerShortTon->MegawattDayPerShortTon")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegawattDaysPerTonne->MegawattDayPerTonne")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegawattHoursPerKilogram->MegawattHourPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - TerawattDaysPerKilogram->TerawattDayPerKilogram")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - TerawattDaysPerShortTon->TerawattDayPerShortTon")]
