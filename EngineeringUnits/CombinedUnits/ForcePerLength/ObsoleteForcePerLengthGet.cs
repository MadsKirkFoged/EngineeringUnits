...
namespace EngineeringUnits
{
    public partial class ForcePerLength
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CentinewtonsPerCentimeter->CentinewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CentinewtonsPerMeter->CentinewtonPerMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CentinewtonsPerMillimeter->CentinewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - DecanewtonsPerCentimeter->DecanewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - DecanewtonsPerMeter->DecanewtonPerMeter")]
        public double DecanewtonsPerMeter => As(ForcePerLengthUnit.DecanewtonPerMeter);

        /// <summary>
        ///     Get ForcePerLength in DecanewtonsPerMillimeter.
        /// </summary>
        [Obsolete("Use without the 's' - DecanewtonsPerMillimeter->DecanewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - DecinewtonsPerCentimeter->DecinewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - DecinewtonsPerMeter->DecinewtonPerMeter")]
        public double DecinewtonsPerMeter => As(ForcePerLengthUnit.DecinewtonPerMeter);

        /// <summary>
        ///     Get ForcePerLength in DecinewtonsPerMillimeter.
        /// </summary>
        [Obsolete("Use without the 's' - DecinewtonsPerMillimeter->DecinewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsForcePerCentimeter->KilogramForcePerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsForcePerMeter->KilogramForcePerMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsForcePerMillimeter->KilogramForcePerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilonewtonsPerCentimeter->KilonewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilonewtonsPerMeter->KilonewtonPerMeter")]
        public double KilonewtonsPerMeter => As(ForcePerLengthUnit.KilonewtonPerMeter);

        /// <summary>
        ///     Get ForcePerLength in KilonewtonsPerMillimeter.
        /// </summary>
        [Obsolete("Use without the 's' - KilonewtonsPerMillimeter->KilonewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerFoot->KilopoundForcePerFoot")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerInch->KilopoundForcePerInch")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MeganewtonsPerCentimeter->MeganewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MeganewtonsPerMeter->MeganewtonPerMeter")]
        public double MeganewtonsPerMeter => As(ForcePerLengthUnit.MeganewtonPerMeter);

        /// <summary>
        ///     Get ForcePerLength in MeganewtonsPerMillimeter.
        /// </summary>
        [Obsolete("Use without the 's' - MeganewtonsPerMillimeter->MeganewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicronewtonsPerCentimeter->MicronewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicronewtonsPerMeter->MicronewtonPerMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicronewtonsPerMillimeter->MicronewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillinewtonsPerCentimeter->MillinewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillinewtonsPerMeter->MillinewtonPerMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillinewtonsPerMillimeter->MillinewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - NanonewtonsPerCentimeter->NanonewtonPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - NanonewtonsPerMeter->NanonewtonPerMeter")]
        public double NanonewtonsPerMeter => As(ForcePerLengthUnit.NanonewtonPerMeter);

        /// <summary>
        ///     Get ForcePerLength in NanonewtonsPerMillimeter.
        /// </summary>
        [Obsolete("Use without the 's' - NanonewtonsPerMillimeter->NanonewtonPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - NewtonsPerCentimeter->NewtonPerCentimeter")]
        public double NewtonsPerCentimeter => As(ForcePerLengthUnit.NewtonPerCentimeter);

        /// <summary>
        ///     Get ForcePerLength in NewtonsPerMeter.
        /// </summary>
        [Obsolete("Use without the 's' - NewtonsPerMeter->NewtonPerMeter")]
       ...
       // public double SI => As(ForcePerLengthUnit.SI);
        ...
        /// </summary>
        [Obsolete("Use without the 's' - TonnesForcePerMeter->TonneForcePerMeter")]
        public double TonnesForcePerMeter => As(ForcePerLengthUnit.TonneForcePerMeter);

        /// <summary>
        ///     Get ForcePerLength in TonnesForcePerMillimeter.
        /// </summary>
        [Obsolete("Use without the 's' - TonnesForcePerMillimeter->TonneForcePerMillimeter")]
