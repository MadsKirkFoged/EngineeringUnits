...
[UnitDimension(BaseunitType.time, 0, BaseunitType.length, 0, BaseunitType.mass, -1, BaseunitType.electricCurrent, 0, BaseunitType.temperature, 0, BaseunitType.amountOfSubstance, 0, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 1)]
public partial class MassCost : BaseUnit
{
    public MassCost() { }
    public MassCost(Fraction value, MassCostUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    {
         return QuantityParser.Parse<MassCost, MassCostUnit>(
         input,
