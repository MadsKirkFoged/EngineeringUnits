...
public partial class RotationalSpeed : BaseUnit
{
    ...
    public RotationalSpeed(Fraction value, RotationalSpeedUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<RotationalSpeedUnit>(_unit, format);

    public static RotationalSpeed Parse(string? input, IFormatProvider? culture = null)
    {
         return QuantityParser.Parse<RotationalSpeed, RotationalSpeedUnit>(
         input,
