...
[UnitDimension(BaseunitType.time, -1, BaseunitType.length, 0, BaseunitType.mass, 0, BaseunitType.electricCurrent, 0, BaseunitType.temperature, 0, BaseunitType.amountOfSubstance, 1, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 0)]
public partial class MolarFlow : BaseUnit
{
    public MolarFlow() { }
    public MolarFlow(Fraction value, MolarFlowUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<MolarFlowUnit>(_unit, format);
