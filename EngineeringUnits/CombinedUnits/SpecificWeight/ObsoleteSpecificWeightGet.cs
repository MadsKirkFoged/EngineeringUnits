...
namespace EngineeringUnits
{
    public partial class SpecificWeight
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsForcePerCubicCentimeter->KilogramForcePerCubicCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsForcePerCubicMeter->KilogramForcePerCubicMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsForcePerCubicMillimeter->KilogramForcePerCubicMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilonewtonsPerCubicCentimeter->KilonewtonPerCubicCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilonewtonsPerCubicMeter->KilonewtonPerCubicMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilonewtonsPerCubicMillimeter->KilonewtonPerCubicMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerCubicFoot->KilopoundForcePerCubicFoot")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerCubicInch->KilopoundForcePerCubicInch")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MeganewtonsPerCubicMeter->MeganewtonPerCubicMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - NewtonsPerCubicCentimeter->NewtonPerCubicCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - NewtonsPerCubicMeter->NewtonPerCubicMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - NewtonsPerCubicMillimeter->NewtonPerCubicMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - PoundsForcePerCubicFoot->PoundForcePerCubicFoot")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - PoundsForcePerCubicInch->PoundForcePerCubicInch")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - TonnesForcePerCubicCentimeter->TonneForcePerCubicCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - TonnesForcePerCubicMeter->TonneForcePerCubicMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - TonnesForcePerCubicMillimeter->TonneForcePerCubicMillimeter")]
