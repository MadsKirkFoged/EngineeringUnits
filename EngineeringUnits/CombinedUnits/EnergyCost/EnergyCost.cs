...
[UnitDimension(BaseunitType.time, 2, BaseunitType.length, -2, BaseunitType.mass, -1, BaseunitType.electricCurrent, 0, BaseunitType.temperature, 0, BaseunitType.amountOfSubstance, 0, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 1)]
public partial class EnergyCost : BaseUnit
{
    public EnergyCost() { }
    public EnergyCost(Fraction value, EnergyCostUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<EnergyCostUnit>(_unit, format);
