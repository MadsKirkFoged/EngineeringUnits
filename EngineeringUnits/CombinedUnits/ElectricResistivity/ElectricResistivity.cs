...
[UnitDimension(BaseunitType.time, -3, BaseunitType.length, 3, BaseunitType.mass, 1, BaseunitType.electricCurrent, -2, BaseunitType.temperature, 0, BaseunitType.amountOfSubstance, 0, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 0)]
public partial class ElectricResistivity : BaseUnit
{
    public ElectricResistivity() { }
    public ElectricResistivity(Fraction value, ElectricResistivityUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<ElectricResistivityUnit>(_unit, format);
