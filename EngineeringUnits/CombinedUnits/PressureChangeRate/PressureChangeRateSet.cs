...
namespace EngineeringUnits
{
    public partial class PressureChangeRate
    {
            ...
            {
                double value= (double)PascalPerSecond;
            ...
            {
                double value= (double)PascalPerMinute;
            ...
            {
                double value= (double)MegapascalPerSecond;
            ...
            {
                double value= (double)MegapascalPerMinute;
            ...
            {
                double value= (double)KilopoundForcePerSquareInchPerSecond;
            ...
            {
                double value= (double)KilopoundForcePerSquareInchPerMinute;
            ...
            {
                double value= (double)KilopascalPerSecond;
            ...
            {
                double value= (double)KilopascalPerMinute;
            ...
            {
                double value= (double)AtmospherePerSecond;
            ...
            {
                double value= (double)PoundForcePerSquareInchPerMinute;
            ...
            {
                double value= (double)PoundForcePerSquareInchPerSecond;
            ...
            {
                double value= (double)MegapoundForcePerSquareInchPerSecond;
            ...
            {
                double value= (double)MegapoundForcePerSquareInchPerMinute;
