...
namespace EngineeringUnits
{
    public partial class PressureChangeRate
    {
        ...
        [Obsolete("Use without the 's' - AtmospheresPerSecond->AtmospherePerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopascalsPerMinute->KilopascalPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopascalsPerSecond->KilopascalPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerSquareInchPerMinute->KilopoundForcePerSquareInchPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerSquareInchPerSecond->KilopoundForcePerSquareInchPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegapascalsPerMinute->MegapascalPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegapascalsPerSecond->MegapascalPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegapoundsForcePerSquareInchPerMinute->MegapoundForcePerSquareInchPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegapoundsForcePerSquareInchPerSecond->MegapoundForcePerSquareInchPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - PascalsPerMinute->PascalPerMinute")]
        public double PascalsPerMinute => As(PressureChangeRateUnit.PascalPerMinute);

        /// <summary>
        ///     Get PressureChangeRate in PascalsPerSecond.
        /// </summary>
        [Obsolete("Use without the 's' - PascalsPerSecond->PascalPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - PoundsForcePerSquareInchPerMinute->PoundForcePerSquareInchPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - PoundsForcePerSquareInchPerSecond->PoundForcePerSquareInchPerSecond")]
