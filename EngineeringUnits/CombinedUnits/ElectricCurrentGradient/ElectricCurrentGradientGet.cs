...
public partial class ElectricCurrentGradient
{
    ...
    /// <summary>
    ///     Get ElectricCurrentGradient in SI.
    /// </summary>
    public new double SI => As(ElectricCurrentGradientUnit.SI);
    /// <summary>
    ///     Get ElectricCurrentGradient in AmperePerSecond.
    /// </summary>
    public double AmperePerSecond => As(ElectricCurrentGradientUnit.AmperePerSecond);
    /// <summary>
