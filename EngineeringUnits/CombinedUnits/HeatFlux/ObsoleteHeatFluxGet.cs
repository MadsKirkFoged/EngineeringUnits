...
namespace EngineeringUnits
{
    public partial class HeatFlux
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CaloriesPerSecondSquareCentimeter->CaloriePerSecondSquareCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CentiwattsPerSquareMeter->CentiwattPerSquareMeter")]
        public double CentiwattsPerSquareMeter => As(HeatFluxUnit.CentiwattPerSquareMeter);

        /// <summary>
        ///     Get HeatFlux in DeciwattsPerSquareMeter.
        /// </summary>
        [Obsolete("Use without the 's' - DeciwattsPerSquareMeter->DeciwattPerSquareMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilocaloriesPerHourSquareMeter->KilocaloriePerHourSquareMeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilocaloriesPerSecondSquareCentimeter->KilocaloriePerSecondSquareCentimeter")]
