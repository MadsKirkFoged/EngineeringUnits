...
namespace EngineeringUnits
{
    public partial class SpecificEntropy
    {
            ...
            public static SpecificEntropy FromJoulePerKilogramRankine(double JoulePerKilogramRankine)
            {
                ...
                return new SpecificEntropy(value, SpecificEntropyUnit.JoulePerKilogramRankine);
            }
            /// <summary>
            ...
            public static SpecificEntropy FromBtuPerPoundKelvin(double BtuPerPoundKelvin)
            {
                ...
                return new SpecificEntropy(value, SpecificEntropyUnit.BtuPerPoundKelvin);
            }
            /// <summary>
            ...
            public static SpecificEntropy FromBtuPerPoundRankine(double BtuPerPoundRankine)
            {
                ...
                return new SpecificEntropy(value, SpecificEntropyUnit.BtuPerPoundRankine);
            }
            /// <summary>
