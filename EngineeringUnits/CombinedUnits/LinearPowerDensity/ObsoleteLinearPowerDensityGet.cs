...
namespace EngineeringUnits
{
    public partial class LinearPowerDensity
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - GigawattsPerCentimeter->GigawattPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - GigawattsPerMillimeter->GigawattPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilowattsPerCentimeter->KilowattPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilowattsPerMillimeter->KilowattPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegawattsPerCentimeter->MegawattPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegawattsPerMillimeter->MegawattPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MilliwattsPerCentimeter->MilliwattPerCentimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MilliwattsPerMillimeter->MilliwattPerMillimeter")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - WattsPerMillimeter->WattPerMillimeter")]
