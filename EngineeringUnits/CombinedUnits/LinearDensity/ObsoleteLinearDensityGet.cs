...
namespace EngineeringUnits
{
    public partial class LinearDensity
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilogramsPerMillimeter->KilogramPerMillimeter")]
