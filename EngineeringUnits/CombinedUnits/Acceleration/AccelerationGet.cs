...
namespace EngineeringUnits
{
    public partial class Acceleration
    {
            ...
            /// <summary>
            ///     Get Acceleration in InchPerSecondSquared.
            /// </summary>
            public double InchPerSecondSquared => As(AccelerationUnit.InchPerSecondSquared);
            /// <summary>
            ///     Get Acceleration in FootPerSecondSquared.
            /// </summary>
            public double FootPerSecondSquared => As(AccelerationUnit.FootPerSecondSquared);
            /// <summary>
            ///     Get Acceleration in KnotPerSecond.
            /// </summary>
            public double KnotPerSecond => As(AccelerationUnit.KnotPerSecond);
            /// <summary>
            ///     Get Acceleration in KnotPerMinute.
            /// </summary>
            public double KnotPerMinute => As(AccelerationUnit.KnotPerMinute);
            /// <summary>
            ///     Get Acceleration in KnotPerHour.
            /// </summary>
            public double KnotPerHour => As(AccelerationUnit.KnotPerHour);
            /// <summary>
