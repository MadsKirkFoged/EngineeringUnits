...
namespace EngineeringUnits
{
    public partial class ElectricPotentialChangeRate
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilovoltsPerHours->KilovoltPerHour")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilovoltsPerMicroseconds->KilovoltPerMicrosecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilovoltsPerMinutes->KilovoltPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilovoltsPerSeconds->KilovoltPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegavoltsPerHours->MegavoltPerHour")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegavoltsPerMicroseconds->MegavoltPerMicrosecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegavoltsPerMinutes->MegavoltPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MegavoltsPerSeconds->MegavoltPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicrovoltsPerHours->MicrovoltPerHour")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicrovoltsPerMicroseconds->MicrovoltPerMicrosecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicrovoltsPerMinutes->MicrovoltPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicrovoltsPerSeconds->MicrovoltPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillivoltsPerHours->MillivoltPerHour")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillivoltsPerMicroseconds->MillivoltPerMicrosecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillivoltsPerMinutes->MillivoltPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillivoltsPerSeconds->MillivoltPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - VoltsPerHours->VoltPerHour")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - VoltsPerMicroseconds->VoltPerMicrosecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - VoltsPerMinutes->VoltPerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - VoltsPerSeconds->VoltPerSecond")]
