...
public partial class ElectricCurrentDensity : BaseUnit
{
    ...
    public ElectricCurrentDensity(Fraction value, ElectricCurrentDensityUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<ElectricCurrentDensityUnit>(_unit, format);

    public static ElectricCurrentDensity Parse(string? input, IFormatProvider? culture = null)
    {
         return QuantityParser.Parse<ElectricCurrentDensity, ElectricCurrentDensityUnit>(
         input,
         (v, u) => new ElectricCurrentDensity(v, u),
         ElectricCurrentDensityUnit.SI,
         culture);
    }
}
