...
public partial class Irradiance
{
    ...
    /// </summary>
    [Obsolete("Use without the 's' - KilowattsPerSquareCentimeter->KilowattPerSquareCentimeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - MegawattsPerSquareCentimeter->MegawattPerSquareCentimeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - MegawattsPerSquareMeter->MegawattPerSquareMeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - MicrowattsPerSquareCentimeter->MicrowattPerSquareCentimeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - MilliwattsPerSquareCentimeter->MilliwattPerSquareCentimeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - NanowattsPerSquareCentimeter->NanowattPerSquareCentimeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - PicowattsPerSquareCentimeter->PicowattPerSquareCentimeter")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - PicowattsPerSquareMeter->PicowattPerSquareMeter")]
    public double PicowattsPerSquareMeter => As(IrradianceUnit.PicowattPerSquareMeter);

    /// <summary>
    ///     Get Irradiance in WattsPerSquareCentimeter.
    /// </summary>
    [Obsolete("Use without the 's' - WattsPerSquareCentimeter->WattPerSquareCentimeter")]
