...
[UnitDimension(BaseunitType.time, -3, BaseunitType.length, 0, BaseunitType.mass, 1, BaseunitType.electricCurrent, 0, BaseunitType.temperature, 0, BaseunitType.amountOfSubstance, 0, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 0)]
public partial class Irradiance : BaseUnit
{
    public Irradiance() { }
    public Irradiance(Fraction value, IrradianceUnit selectedUnit) : base(value, selectedUnit.Unit) { }
