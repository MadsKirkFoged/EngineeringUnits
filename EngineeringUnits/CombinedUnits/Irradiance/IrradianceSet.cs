...
namespace EngineeringUnits
{
    ...
    public partial class Irradiance
    {
            ...
            {
                double value= (double)WattPerSquareCentimeter;
            ...
            {
                double value= (double)KilowattPerSquareCentimeter;
            ...
            {
                double value= (double)MegawattPerSquareCentimeter;
            ...
            {
                double value= (double)MicrowattPerSquareCentimeter;
            ...
            {
                double value= (double)MilliwattPerSquareCentimeter;
            ...
            {
                double value= (double)NanowattPerSquareCentimeter;
            ...
            {
                double value= (double)PicowattPerSquareCentimeter;
            ...
            {
                double value= (double)MegawattPerSquareMeter;
            ...
            {
                double value= (double)PicowattPerSquareMeter;
