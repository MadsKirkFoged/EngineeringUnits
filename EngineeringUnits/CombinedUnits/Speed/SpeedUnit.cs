...
namespace EngineeringUnits
{
    ...
    public class SpeedUnit : Enumeration
    {
        ...
        public static IEnumerable<SpeedUnit> List()
        {
            return new[] { CentimeterPerHour, CentimeterPerMinute, CentimeterPerSecond, DecimeterPerMinute, DecimeterPerSecond, FootPerHour, FootPerMinute, FootPerSecond, InchPerHour, InchPerMinute, InchPerSecond, KilometerPerHour, KilometerPerMinute, KilometerPerSecond, Knot, MeterPerHour, MeterPerMinute, MeterPerSecond, MicrometerPerMinute, MicrometerPerSecond, MilePerHour, MillimeterPerHour, MillimeterPerMinute, MillimeterPerSecond, NanometerPerMinute, NanometerPerSecond, UsSurveyFootPerHour, UsSurveyFootPerMinute, UsSurveyFootPerSecond, YardPerHour, YardPerMinute, YardPerSecond, };
        }
