...
public partial class ThermalResistance
{
    ...
    {
        var value = (double)hoursquarefeetdegreesfahrenheitperbtu;
    ...
    {
        var value = (double)squarecentimeterhourdegreescelsiusperkilocalorie;
    ...
    {
        var value = (double)squarecentimeterkelvinsperwatt;
    ...
    {
        var value = (double)squaremeterdegreescelsiusperwatt;
    ...
    {
        var value = (double)squaremeterkelvinsperkilowatt;
