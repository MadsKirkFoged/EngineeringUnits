...
public partial class ThermalResistance : BaseUnit
{
    ...
    public ThermalResistance(Fraction value, ThermalResistanceUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<ThermalResistanceUnit>(_unit, format);

    public static ThermalResistance Parse(string? input, IFormatProvider? culture = null)
    {
         return QuantityParser.Parse<ThermalResistance, ThermalResistanceUnit>(
         input,
