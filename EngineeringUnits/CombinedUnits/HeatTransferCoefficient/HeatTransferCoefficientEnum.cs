...
namespace EngineeringUnits
{
    ...
    public class HeatTransferCoefficientUnit : Enumeration
    {
        ...
        public static IEnumerable<HeatTransferCoefficientUnit> List()
        {
            return new[] { BtuPerSquareFootDegreeFahrenheit, WattPerSquareMeterCelsius, WattPerSquareMeterKelvin, };
        }
