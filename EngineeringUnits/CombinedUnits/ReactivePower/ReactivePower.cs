...
public partial class ReactivePower : BaseUnit
{
    ...
    public ReactivePower(Fraction value, ReactivePowerUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    {
         return QuantityParser.Parse<ReactivePower, ReactivePowerUnit>(
         input,
