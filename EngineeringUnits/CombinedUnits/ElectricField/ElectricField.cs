...
public partial class ElectricField : BaseUnit
{
    ...
    public ElectricField(Fraction value, ElectricFieldUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    {
         return QuantityParser.Parse<ElectricField, ElectricFieldUnit>(
         input,
