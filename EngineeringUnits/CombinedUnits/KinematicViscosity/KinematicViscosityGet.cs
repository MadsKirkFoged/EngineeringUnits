...
public partial class KinematicViscosity
{
    ...
    /// </summary>
    public new double SI => As(KinematicViscosityUnit.SI);
    /// <summary>
    ///     Get KinematicViscosity in SquareMeterPerSecond.
    /// </summary>
    public double SquareMeterPerSecond => As(KinematicViscosityUnit.SquareMeterPerSecond);
    /// <summary>
