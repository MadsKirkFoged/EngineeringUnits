...
[UnitDimension(BaseunitType.time, -1, BaseunitType.length, 0, BaseunitType.mass, 0, BaseunitType.electricCurrent, 0, BaseunitType.temperature, 1, BaseunitType.amountOfSubstance, 0, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 0)]
public partial class TemperatureChangeRate : BaseUnit
{
    public TemperatureChangeRate() { }
    public TemperatureChangeRate(Fraction value, TemperatureChangeRateUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<TemperatureChangeRateUnit>(_unit, format);

    public static TemperatureChangeRate Parse(string? input, IFormatProvider? culture = null)
    {
         return QuantityParser.Parse<TemperatureChangeRate, TemperatureChangeRateUnit>(
         input,
