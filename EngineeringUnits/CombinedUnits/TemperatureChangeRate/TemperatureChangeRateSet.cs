...
namespace EngineeringUnits
{
    public partial class TemperatureChangeRate
    {
            ...
            {
                double value= (double)DegreeCelsiusPerSecond;
            ...
            {
                double value= (double)DegreeCelsiusPerMinute;
            ...
            {
                double value= (double)CentidegreeCelsiusPerSecond;
            ...
            {
                double value= (double)DecadegreeCelsiusPerSecond;
            ...
            {
                double value= (double)DecidegreeCelsiusPerSecond;
            ...
            {
                double value= (double)HectodegreeCelsiusPerSecond;
            ...
            {
                double value= (double)KilodegreeCelsiusPerSecond;
            ...
            {
                double value= (double)MicrodegreeCelsiusPerSecond;
            ...
            {
                double value= (double)MillidegreeCelsiusPerSecond;
            ...
            {
                double value= (double)NanodegreeCelsiusPerSecond;
