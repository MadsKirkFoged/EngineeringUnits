...
public partial class TemperatureChangeRate
{
    ...
    /// </summary>
    [Obsolete("Use without the 's' - CentidegreesCelsiusPerSecond->CentidegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - DecadegreesCelsiusPerSecond->DecadegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - DecidegreesCelsiusPerSecond->DecidegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - DegreesCelsiusPerMinute->DegreeCelsiusPerMinute")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - DegreesCelsiusPerSecond->DegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - HectodegreesCelsiusPerSecond->HectodegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - KilodegreesCelsiusPerSecond->KilodegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - MicrodegreesCelsiusPerSecond->MicrodegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - MillidegreesCelsiusPerSecond->MillidegreeCelsiusPerSecond")]
    ...
    /// </summary>
    [Obsolete("Use without the 's' - NanodegreesCelsiusPerSecond->NanodegreeCelsiusPerSecond")]
