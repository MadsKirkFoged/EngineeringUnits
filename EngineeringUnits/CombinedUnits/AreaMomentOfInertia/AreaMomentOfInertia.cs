...
[UnitDimension(BaseunitType.time, 0, BaseunitType.length, 4, BaseunitType.mass, 0, BaseunitType.electricCurrent, 0, BaseunitType.temperature, 0, BaseunitType.amountOfSubstance, 0, BaseunitType.luminousIntensity, 0, BaseunitType.Cost, 0)]
public partial class AreaMomentOfInertia : BaseUnit
{
    public AreaMomentOfInertia() { }
    public AreaMomentOfInertia(Fraction value, AreaMomentOfInertiaUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    {
         return QuantityParser.Parse<AreaMomentOfInertia, AreaMomentOfInertiaUnit>(
         input,
         (v, u) => new AreaMomentOfInertia(v, u),
         AreaMomentOfInertiaUnit.SI,
         culture);
    }
}
