...
namespace EngineeringUnits
{
    public partial class ForceChangeRate
    {
        ...
        /// </summary>
        [Obsolete("Use without the 's' - CentinewtonsPerSecond->CentinewtonPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerMinute->KilopoundForcePerMinute")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - KilopoundsForcePerSecond->KilopoundForcePerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MicronewtonsPerSecond->MicronewtonPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - MillinewtonsPerSecond->MillinewtonPerSecond")]
        ...
        /// </summary>
        [Obsolete("Use without the 's' - PoundsForcePerMinute->PoundForcePerMinute")]
        public double PoundsForcePerMinute => As(ForceChangeRateUnit.PoundForcePerMinute);

        /// <summary>
        ///     Get ForceChangeRate in PoundsForcePerSecond.
        /// </summary>
        [Obsolete("Use without the 's' - PoundsForcePerSecond->PoundForcePerSecond")]
