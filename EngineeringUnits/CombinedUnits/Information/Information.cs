...
{
    public Information() { }
    public Information(Fraction value, InformationUnit selectedUnit) : base(value, selectedUnit.Unit) { }
    ...
    {
         return QuantityParser.Parse<Information, InformationUnit>(
         input,
         (v, u) => new Information(v, u),
         InformationUnit.SI,
         culture);
    }
}
