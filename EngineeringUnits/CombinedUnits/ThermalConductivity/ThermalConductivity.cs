...
public partial class ThermalConductivity : BaseUnit
{
    ...
    public override string? GetStandardSymbol(UnitSystem _unit, string? format = null) => GetStandardSymbol<ThermalConductivityUnit>(_unit, format);

    public static ThermalConductivity Parse(string? input, IFormatProvider? culture = null)
    {
         return QuantityParser.Parse<ThermalConductivity, ThermalConductivityUnit>(
         input,
