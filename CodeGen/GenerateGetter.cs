...
");
        ...
        /// <summary>
        /// This method generate getter class for all units with the "s" at the end of each method
        /// </summary>
        /// <param name="projectPath"></param>

        public static void GenerateGetterClassesWithS(string projectPath)
        {
            ...
            foreach (var item in GetListOfCombinedUnits())
            {
                ...
                File.WriteAllText(Path.Combine(projectPathWithUnit, $"{item}GetOld.cs"), sb.ToString());
        ...
        public static string GetterWithS(string className)
        {
            StringBuilder sb = new StringBuilder();
...
namespace EngineeringUnits
{
 ...
 ");
            ...
            ///     Get Variable in UnitEnum.
            /// </summary>
            [Obsolete(""Use without the 's' - UnitEnums->UnitEnum"")]
            public double UnitEnums => As(VariableUnit.UnitEnum);");
